        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('truyen.store')}}" id="themtruyen" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="tentruyen" class="form-label">Tên truyện</label>
                            <input type="text" class="form-control" value="{{old('tentruyen')}}" name="tentruyen" id="create_slug" onkeyup="ChangeToSlug();" aria-describedby="truyen" placeholder="Nhập tên truyện">
                        </div>
                        <div class="mb-3">
                            <label for="slugtheloai" class="form-label">Slug truyện</label>
                            <input readonly type="text" class="form-control" value="{{old('slug_truyen')}}" name="slug_truyen" id="convert_slug" aria-describedby="truyen" placeholder="Slug truyện">
                        </div>
                        <div class="mb-3">
